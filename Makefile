...
# bitwarden/sm-operator-bundle:$VERSION and bitwarden/sm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= localhost/sm-operator
...
.PHONY: docker-save
docker-save: ## Save docker image to archive.
	$(CONTAINER_TOOL) save ${IMG} -o ./sm-operator.tar
...
helm: manifests kustomize helmify
	$(KUSTOMIZE) build config/default | $(HELMIFY) $(LOCALBIN)/charts/sm-operator
